...
const ContactUs = () => {
    return (
        <div data-aos="fade-down"
            ...
            data-aos-duration="1500" id='contact' className="container my-24 px-6 mx-auto">
            <h2 className="text-3xl text-secondary font-bold text-center mb-6 flex justify-center items-center">
      ...
      " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                                    ...
                                    <button type="submit" className="w-full px-6 py-2.5 bg-gradient-to-r from-secondary to-primary text-white font-medium text-xs">Send</button>
                                </form>
                            </div>
