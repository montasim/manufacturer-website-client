                    ...
                    <div class="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form class="w-full text-white">
                                ...
                                <div class="p-2 border sm:flex sm:items-center border-white/10 rounded-lg">
                                    ...
                                    <button class="w-full h-12 px-6 py-3 mt-1 rounded-lg text-sm font-bold tracking-wide uppercase bg-red-700 sm:ml-4 sm:flex-shrink-0 sm:w-auto sm:mt-0" type="submit">
                                        Subscribe
                                    </button>
                                </div>
                            </form>
