                    ...
                    <div className='grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16'>
                        ...
                        <div className='col-span-2 pt-6 border-t sm:col-span-1 border-white/10'>
                            ...
                            <nav className='flex flex-col mt-6 space-y-4 text-sm text-gray-300'>
                                <Link className='inline-block' to=''> 1on1 Coaching </Link>
                                <Link className='inline-block' to=''> Company Review </Link>
                                <Link className='inline-block' to=''> Accounts Review </Link>
                                <Link className='inline-block' to=''> HR Consulting </Link>
                                <Link className='inline-block' to=''> SEO Optimisation </Link>
                            </nav>
                        </div>
